...
<div class="cabecalho-pagina">
  ...
  <a href="<?= url('projetos/novo') ?>" class="botao-primario"><i class="bi bi-plus-lg"></i> Novo projeto</a>
</div>
  ...
  <tbody>
    ...
    <?php else: ?>
      ...
      <tr>
        ...
        <td>
          <a href="<?= url("projetos/{$projeto->id}") ?>" class="botao-secundario" style="font-size:.78rem; padding:.25rem .6rem;">
