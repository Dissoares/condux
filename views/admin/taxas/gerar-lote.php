...
<div class="cabecalho-pagina">
  ...
  <a href="<?= $urlBase ?>/index.php?pagina=taxas" class="botao-secundario">
...
<div class="card-conteudo" style="max-width:480px;">
  ...
  <form action="<?= $urlBase ?>/index.php?pagina=taxas&acao=gerarEmLote" method="POST">
    ...
    <div class="campo-formulario" style="margin-bottom:1rem;">
      ...
      <input type="text" id="campo-valor" name="valor"
